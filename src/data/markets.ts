...
const us: Omit<Stock, "series">[] = [
  ...
  { symbol: "GOOGL", name: loc("Alphabet", "ألفابت"), market: "us", domain: "abc.xyz", sector: loc("Technology", "التقنية"), price: 191.3, change: 0.91, marketCap: 2340, low52: 130, high52: 202, peRatio: 25.4, color: "#ec4899", about: loc("The parent of Google, YouTube, and DeepMind.", "الشركة الأم لجوجل ويوتيوب وديب مايند.") },
