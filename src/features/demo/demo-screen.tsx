...
import { User, Building2, UserCog, Loader2, ArrowRight, KeyRound, type LucideIcon } from "lucide-react";
...
export type DemoUser = {
  ...
  name: Localized;
  firstName: Localized;
  kind: "personal" | "owner" | "employee";
  companyName: Localized | null;
};

const KIND_META: Record<DemoUser["kind"], { icon: LucideIcon; accent: string; badge: string; desc: string }> = {
  personal: { icon: User, accent: "var(--brand)", badge: "badgePersonal", desc: "descPersonal" },
  owner: { icon: Building2, accent: "var(--primary)", badge: "badgeOwner", desc: "descOwner" },
  employee: { icon: UserCog, accent: "var(--info)", badge: "badgeEmployee", desc: "descEmployee" },
};
